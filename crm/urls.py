...
from django.urls import path
from .views import dashboard, diabetes_risk_create
from .views_search import global_search, person_activity
urlpatterns = [
    ...
    path("search/person/", person_activity, name="person_activity"),
]
